...
На каждом шаге тебе доступны только базовые инструменты. Если нужна другая возможность — сначала вызови search_tools с короткими ключевыми словами, затем используй найденный инструмент.
