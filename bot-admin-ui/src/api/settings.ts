...
export function createPaymentType(payload: { name: string; currency: "UZS" | "USD" }) {
...
export function updatePaymentType(id: number, payload: { name: string; currency: "UZS" | "USD" }) {
