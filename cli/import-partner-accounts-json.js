...
const { parsePartnerAccountsFromTablesJson } = require('../src/sync/partner-accounts-parser');
const { outputDir } = require('../src/paths');

const inputPath = process.argv[2] || path.join(outputDir(), 'partner-accounts-tables.json');
