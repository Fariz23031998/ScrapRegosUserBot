...
const { openDb, upsertPartners, startFetchRun, finishFetchRun, countPartners } = require('../src/db/partners-db');
const { parsePartnersFromTablesJson } = require('../src/sync/partners-parser');
const { outputDir } = require('../src/paths');

const inputPath = process.argv[2] || path.join(outputDir(), 'partners-tables.json');
